...
struct Struct80331A54 D_80331A54[][5] = {
    ...
    {
        { 0, MODEL_RR_TRICKY_TRIANGLES_FRAME4 },
        { 0, MODEL_RR_TRICKY_TRIANGLES_FRAME3 },
        { 0, MODEL_RR_TRICKY_TRIANGLES_FRAME2 },
        { 0, MODEL_RR_TRICKY_TRIANGLES_FRAME1 },
        { 0, MODEL_RR_TRICKY_TRIANGLES },
    },
};
