    ...
    if (obj_lava_death() == 1) {
        if (o->oBehParams2ndByte == BULLY_BP_SIZE_SMALL) {
            ...
            if (o->oBullySubtype == BULLY_STYPE_CHILL)
                ...
                spawn_default_star(o->oHomeX, o->oHomeY-800.f, o->oHomeZ);
            }
        }
    }
}
...
void bhv_big_bully_with_minions_init(void) {
    big_bully_spawn_minion(-2798, -181, 4056, 0);
    big_bully_spawn_minion(-2388, -181, 4663, 0);
    big_bully_spawn_minion(-3133, -181, 4613, 0);
