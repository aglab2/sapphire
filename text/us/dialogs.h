...
DEFINE_DIALOG(DIALOG_057, 1, 3, 30, 200, _("\
Hey bro. I lost my kid for\n\
like the 69th time. Can\n\
you do your thing?"))

DEFINE_DIALOG(DIALOG_058, 1, 4, 30, 200, _("\
Thanks bro. See you next\n\
...
DEFINE_DIALOG(DIALOG_076, 1, 1, 30, 200, _("\
First try, idiot!"))
...
DEFINE_DIALOG(DIALOG_093, 1, 1, 30, 200, _("\
Don't choke the throws!"))
...
DEFINE_DIALOG(DIALOG_121, 1, 2, 30, 200, _("\
Tan me hide when I'm\n\
dead, Fred."))
