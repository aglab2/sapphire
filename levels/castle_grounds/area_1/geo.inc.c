...
const GeoLayout castle_grounds_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_grounds_dl_Main_mesh),
		GEO_DISPLAY_LIST(LAYER_ALPHA, castle_grounds_dl_Main_001_mesh),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_grounds_dl_Nonsolid_mesh),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
