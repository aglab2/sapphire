...
const LevelScript level_bits_entry[] = {
	...
	AREA(1, bits_area_1),
		...
		WARP_NODE(0xf0, LEVEL_CASTLE_GROUNDS, 0x01, 0xD4, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_CASTLE_GROUNDS, 0x01, 0xe4, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0B, LEVEL_CCM, 0x02, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0C, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -541, -1753, 279, 0, -180, 0, 0x000A0000, bhvSpinAirborneWarp),
