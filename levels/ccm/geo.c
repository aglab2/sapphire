...
#include "levels/ccm/sinkinlava/geo.inc.c"
#include "levels/ccm/tiltpyramid/geo.inc.c"
#include "levels/ccm/sinkblock/geo.inc.c"
#include "levels/ccm/hexring/geo.inc.c"
#include "levels/ccm/firehat/geo.inc.c"