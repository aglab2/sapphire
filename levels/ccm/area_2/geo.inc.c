...
const GeoLayout ccm_area_2_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -275, 1610, 204, ccm_dl_Shape_IndexedFaceSet_001_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_ALPHA, -878, 1832, -2091, ccm_dl_Shape_IndexedFaceSet_019_mesh),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout ccm_area_2[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_CAMERA(CAMERA_MODE_8_DIRECTIONS, -10315, -564, -4631, -10315, -565, -4631, geo_camera_main),
				GEO_OPEN_NODE(),
