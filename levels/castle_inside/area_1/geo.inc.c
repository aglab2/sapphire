...
const GeoLayout castle_inside_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_inside_dl_Main_mesh),
		GEO_DISPLAY_LIST(LAYER_ALPHA, castle_inside_dl_Main_001_mesh),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_inside_dl_Nonsolid_mesh),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
